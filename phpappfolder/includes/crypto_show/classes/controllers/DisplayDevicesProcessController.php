<?php
/**
 * class.DisplayDevicesProcessController.php
 *
...
class DisplayDevicesProcessController extends ControllerAbstract
{
    ...
    private function getDevices($validated_input)
    {

        $database = Factory::createDatabaseWrapper();
        $model = Factory::buildObject('GetDevicesProcessModel');
